...
**Q01.** A vector of students' exam scores has been initialized. scores <- c(89, 70, 75, 86, 90, 95, 100) Create a **factor** with levels of scores as follows: **Poor: [0,70); Good: [70,86); Excellent: [86,100]** <br>
**Output:** <br> 
...
```{r}
scores <- c(89, 70, 75, 86, 90, 95, 100)

score_factor <- cut(
  scores,
  breaks = c(0, 70, 86, 100),
...
```{r}
score_factor[score_factor == "Good"]
...
class <- list(
  ...
  c("Online","OnCampus","Online","OnCampus","OnCampus",
    "Online","OnCampus","OnCampus","Online")
)
